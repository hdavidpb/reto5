...
import tutoria.Servicios.ServiciosOrtopedic;
...
public class OrtopedicWeb {
    ...
    @GetMapping("/{id}")
    public Optional<Ortopedic> getOrthesis(@PathVariable("id") int idOrtopedic) {
        return servicio.getFinca(idOrtopedic);
    }
    ...
    public boolean delete(@PathVariable("id") int ortopedicId) {
        return servicio.deleteFinca(ortopedicId);
    }
}
